...
- (void)layoutSubviews
{
	...
	if (!_loaded) {
        ...
        NSArray * horizontalConstriants = [NSLayoutConstraint constraintsWithVisualFormat:@"H:|[sign]|" options:NSLayoutFormatAlignAllCenterY metrics:nil views:@{@"sign": self.sign}];
        NSArray * verticalConstriants = [NSLayoutConstraint constraintsWithVisualFormat:@"V:|[sign]|" options:NSLayoutFormatAlignAllCenterX metrics:nil views:@{@"sign": self.sign}];
        [NSLayoutConstraint activateConstraints:horizontalConstriants];
        [NSLayoutConstraint activateConstraints:verticalConstriants];
